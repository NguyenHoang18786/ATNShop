                          ...
                          $pw_heroku = "e77829266d73cbd262849d8d0f071233f6bd1fcaec827e4f57d10a008ee1b6ac"; 
                           ...
                           $pg_heroku = pg_connect($conn_string);
                               ...
                               if (isset($_POST['submitu'])) {
                                  $query6 = "update atnshop_storage set product_name = '$productnameu', product_type = '$producttypeu', product_price = '$productpriceu', 
                                               shop_id = '$shopidu' where product_id = '$productidu' ";
